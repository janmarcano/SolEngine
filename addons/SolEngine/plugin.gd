...
func _enter_tree():
	...
	add_custom_type("ComicPanel", "Polygon2D", preload("panel.gd"), preload("icon.png"))
	...
	add_custom_type("ParallaxContent", "TextureRect", preload("parallax_content.gd"), preload("icon.png"))
...
func _exit_tree():
	...
	remove_custom_type("ParallaxContent")
